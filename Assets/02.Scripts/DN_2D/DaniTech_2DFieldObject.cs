...
public class DaniTech_2DFieldObject : MonoBehaviour
{
    ...
    {
        var fieldObjectData = GameDataManager.Instance.GetData<FieldObjectData>(fieldObjectDataId);
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if(collision.CompareTag("Player") == true)
        {
            ...
            var fieldObjectData = GameDataManager.Instance.GetData<FieldObjectData>(_fieldObjectDataId);
            if (fieldObjectData == null)
            {
            ...
            if(fieldObjectData.FieldObjectType == "Harvest"  ||  fieldObjectData.FieldObjectType == "DropItem")
            {
                ...
                var itemData = GameDataManager.Instance.GetData<ItemData>(fieldObjectData.DropItemDataId);
                if(itemData == null)
                {
